...
Estamos no Módulo 1, consolidando arrays numéricos.
...
buscar valores;
usar flag encontrou;
guardar posição encontrada;
tratar índice inválido.
```

Agora vamos consolidar quatro operações fundamentais:
...
Essas operações aparecem em praticamente qualquer sistema que trabalhe com números.
...
total de pedidos;
média de pagamentos;
maior valor de uma transação;
menor estoque;
maior tempo de atendimento;
menor quantidade de atividades;
total de eventos de auditoria;
média de tentativas de mensageria.
```

A aula de hoje não é apenas sobre fazer conta.

É sobre percorrer dados e produzir relatório final.
...
Quando soma, média, maior ou menor der errado, siga o roteiro.

### 1. O array tem elementos?
...
### 2. O loop percorre índices válidos?
...
### 4. Maior e menor começam com valores[0]?

Evite valores artificiais.

### 5. Você está somando o valor ou o índice?
...
### 6. A média é calculada depois do loop?

Primeiro soma tudo, depois divide.

### 7. A divisão é decimal?
...
Verifique a regra para empate.

### 9. O menor usa `<`?

Verifique a regra para empate.

### 10. O relatório final está claro?
...
### Teste 1 — Maior inicializado com zero
...
### Teste 2 — Menor inicializado com zero
...
### Teste 3 — Média com divisão inteira
...
### Teste 4 — Somar índice em vez do valor
...
| Ação | Atalho | Uso |
|---|---|---|
| Reformatar código | `Ctrl + Alt + L` | Organizar loops e relatório |
| Renomear variável | `Shift + F6` | Melhorar nomes como `maior`, `menor`, `soma` |
| Terminal integrado | `Alt + F12` | Compilar e executar |
| Rodar programa | `Shift + F10` | Executar no IntelliJ |
| Debug | `Shift + F9` | Ver acumulador e comparações |
...
### O que aprendi
Aprendi a gerar relatório numérico de arrays calculando soma, média, maior valor e menor valor, com inicialização correta e comparação durante o loop.

### O que pratiquei
Criei exemplos separados de soma, média, maior e menor, depois uni tudo em relatórios aplicados a estoque, pedidos, pagamentos, OS, mensageria, auditoria, SLA e valores informados pelo usuário.
...
### Arquivos criados
- `labs/m1/aula-049-maior-menor-soma-media-array/Main.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/SomaValores.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/MediaValores.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/MaiorValor.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/MenorValor.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioArray.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioComArrayVazio.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioComNegativos.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioPagamentosCentavos.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioNotasDouble.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioEstoqueProdutos.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioPedidos.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioPagamentos.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioAtividadesOs.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioMensageria.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioAuditoria.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioSla.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioValoresUsuario.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/RelatorioPagamentosUsuario.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ValoresAcimaDaMedia.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ValoresAcimaDoLimite.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/MaiorMenorComPosicao.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/EmpateMaiorValor.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ErroMaiorInicialZero.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ErroMenorInicialZero.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ErroMediaInteira.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ErroSomarIndice.java`
- `labs/m1/aula-049-maior-menor-soma-media-array/ErroArrayVazio.java`
...
- inicializar maior com zero;
- inicializar menor com zero;
- acessar `valores[0]` em array vazio;
- usar `<= valores.length`;
- calcular média dentro do loop sem necessidade;
- esquecer cast para `double`;
- somar índice em vez de valor;
- comparar índice em vez de valor;
- não atualizar posição do maior ou menor;
- não organizar relatório final.

### Próximo passo
Estudar arrays de String.
```
...
```text
1. Por que soma normalmente começa com 0?
2. Por que maior não deve começar sempre com 0?
3. Por que menor não deve começar sempre com 0?
4. Por que `valores[0]` é uma boa inicialização para maior e menor?
5. Qual cuidado existe se o array estiver vazio?
6. Como calcular média decimal corretamente?
7. Qual a diferença entre índice e valor na soma?
8. Como guardar a posição do maior valor?
9. O que muda se usar `>` ou `>=` ao buscar o maior?
10. O que um relatório final deve mostrar para ser claro?
```
