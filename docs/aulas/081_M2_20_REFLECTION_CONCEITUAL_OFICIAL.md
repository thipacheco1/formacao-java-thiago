...
Na aula anterior, estudamos annotations básicas.

Vimos que annotation é metadado no código.

Agora vamos entender uma das formas de ler e usar metadados em tempo de execução:

```text
reflection.
```

Reflection é muito importante para entender frameworks Java.
...
## Diagnóstico de reflection

Quando revisar código com reflection, pergunte:

### 1. O tipo era conhecido?

Se sim, por que não chamada direta?

### 2. O uso é infraestrutura ou regra de negócio?

Reflection combina mais com infraestrutura.

### 3. Há annotation envolvida?

Confira retention e target.

### 4. Há strings de campo/método?

Verifique risco de quebra.

### 5. O código depende de ordem?
...
### 7. Há tratamento de exceção claro?

Não esconda erro.

### 8. O teste cobre o mecanismo?

Precisa cobrir.

### 9. O ganho justifica complexidade?

Se não, remova.

### 10. O time entende?

Se não, documente ou simplifique.
...
```java
Cliente.class.getDeclaredField("nomeCompleto");
```

Se o campo não existe, ocorre:

```text
NoSuchFieldException.
```

Explique por que isso só aparece em runtime.
...
```java
Cliente.class.getDeclaredMethod("buscarNome");
```

Se o método não existe, ocorre:
...
### Teste 3 — annotation sem RUNTIME
...
Tente ler com `getAnnotation`.

Explique por que pode retornar `null`.

---

### Teste 4 — chamar método privado sem setAccessible

Tente invocar método privado sem liberar acesso.

Explique o erro de acesso.

---

### Teste 5 — reflection onde chamada direta era melhor

Escreva um exemplo chamando `getNome` via reflection.

Depois reescreva com chamada direta.

Explique qual é mais claro.
...
Entender reflection em Java de forma conceitual e prática, incluindo `Class`, campos, métodos, construtores, annotations, leitura de metadados, uso por frameworks e riscos.

## Conceitos

- Reflection permite inspecionar classes em runtime.
- `Class` representa a estrutura de uma classe.
...
- `getDeclaredConstructors` lista construtores declarados.
- `getAnnotation` lê annotation.
- `isAnnotationPresent` verifica annotation.
- Reflection é muito usada por frameworks.
- Reflection pode quebrar encapsulamento.
- `setAccessible(true)` exige cuidado.
- Erros com reflection podem aparecer só em runtime.
- Não depender da ordem de campos/métodos.
- Não usar reflection quando chamada direta resolve.
...
| Debug | `Shift + F9` | Inspecionar Class, Field e Method |
| Run | `Shift + F10` | Executar normal |
| Step Over | `F8` em muitos keymaps | Avançar leitura reflection |
| Variables | janela Debug | Ver arrays de campos/métodos |
| Evaluate Expression | `Alt + F8` em muitos keymaps | Testar `getDeclaredFields`, `getAnnotation` |
| Reformatar código | `Ctrl + Alt + L` | Organizar |
| Renomear | `Shift + F6` | Testar risco de strings mágicas |
...
### O que aprendi
Aprendi que reflection permite inspecionar classes, campos, métodos, construtores e annotations em tempo de execução. Também aprendi que frameworks usam reflection para ler metadados e criar comportamentos genéricos, mas que reflection deve ser usada com cuidado.

### O que pratiquei
Criei exemplos com `Class`, `getClass`, `Class.forName`, leitura de campos, métodos, parâmetros, construtores, annotations de classe e campo, validador simples, criação de objeto por construtor, invocação de método e leitura de valor de campo.
...
### Arquivos criados
- `labs/m2/aula-081-reflection-conceitual/Main.java`
- `labs/m2/aula-081-reflection-conceitual/ClassComObjeto.java`
- `labs/m2/aula-081-reflection-conceitual/ClassForNameExemplo.java`
- `labs/m2/aula-081-reflection-conceitual/LerCampos.java`
- `labs/m2/aula-081-reflection-conceitual/LerMetodos.java`
- `labs/m2/aula-081-reflection-conceitual/LerParametrosMetodo.java`
- `labs/m2/aula-081-reflection-conceitual/LerConstrutores.java`
- `labs/m2/aula-081-reflection-conceitual/Tabela.java`
- `labs/m2/aula-081-reflection-conceitual/ClienteTabela.java`
- `labs/m2/aula-081-reflection-conceitual/LerAnnotationClasse.java`
- `labs/m2/aula-081-reflection-conceitual/IsAnnotationPresentExemplo.java`
- `labs/m2/aula-081-reflection-conceitual/CampoObrigatorio.java`
- `labs/m2/aula-081-reflection-conceitual/ClienteCamposObrigatorios.java`
- `labs/m2/aula-081-reflection-conceitual/LerAnnotationCampo.java`
- `labs/m2/aula-081-reflection-conceitual/ValidadorObrigatorio.java`
- `labs/m2/aula-081-reflection-conceitual/ClienteValidavel.java`
- `labs/m2/aula-081-reflection-conceitual/ExecutarValidador.java`
- `labs/m2/aula-081-reflection-conceitual/CriarObjetoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/InvocarMetodoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/LerValorCampo.java`
- `labs/m2/aula-081-reflection-conceitual/ClienteReflection.java`
- `labs/m2/aula-081-reflection-conceitual/ProdutoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/PedidoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/PagamentoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/OrdemServicoReflection.java`
- `labs/m2/aula-081-reflection-conceitual/CanalMensagem.java`
- `labs/m2/aula-081-reflection-conceitual/MensagemReflection.java`
- `labs/m2/aula-081-reflection-conceitual/LeitorCanalReflection.java`
- `labs/m2/aula-081-reflection-conceitual/Auditavel.java`
- `labs/m2/aula-081-reflection-conceitual/ProdutoAuditavel.java`
- `labs/m2/aula-081-reflection-conceitual/LeitorAuditavel.java`
- `labs/m2/aula-081-reflection-conceitual/DebugReflection.java`
- `labs/m2/aula-081-reflection-conceitual/ErroCampoInexistente.java`
- `labs/m2/aula-081-reflection-conceitual/ErroMetodoInexistente.java`
- `labs/m2/aula-081-reflection-conceitual/ErroAnnotationSemRuntime.java`
- `labs/m2/aula-081-reflection-conceitual/ErroMetodoPrivadoSemAcesso.java`
- `labs/m2/aula-081-reflection-conceitual/ErroReflectionDesnecessaria.java`
- `labs/m2/aula-081-reflection-conceitual/README.md`
...
- usar reflection sem necessidade;
- esquecer que erro pode aparecer só em runtime;
- depender de ordem de campos/métodos;
- quebrar encapsulamento com `setAccessible`;
- ignorar exceções;
- esquecer `RetentionPolicy.RUNTIME` em annotation;
- usar string mágica para nome de campo;
- criar magia sem documentação;
- usar reflection quando chamada direta é melhor;
- esconder regra de negócio atrás de reflection.

### Próximo passo
Estudar sealed classes e interfaces.
```
...
2. Para que serve Class?
3. Para que serve Field?
4. Para que serve Method?
5. Para que serve Constructor?
6. Como obter Class usando .class?
7. Como obter Class usando getClass?
8. Como obter Class usando Class.forName?
9. Para que serve getDeclaredFields?
10. Qual a diferença entre getDeclaredFields e getFields?
11. Para que serve getDeclaredMethods?
12. Para que serve getDeclaredConstructors?
13. Como ler annotation de uma classe?
14. Como ler annotation de um campo?
15. Por que RetentionPolicy.RUNTIME é importante?
16. Para que serve setAccessible?
17. Por que setAccessible exige cuidado?
18. Por que reflection pode quebrar só em runtime?
19. Quando usar reflection?
20. Quando evitar reflection?
```
