...
const DOMAIN_PROGRAMS = [
  {
    ...
    output: 'Soma: 13\nSubtração: 7\nMultiplicação: 30\nDivisão: 3\nResto: 1',
    insight: 'A divisão de valorA (10) por valorB (3) retorna 3 absoluto porque ambos os lados da operação são inteiros primitivos.'
  },
  {
...
const ERRORS = [
  ...
  { title: 'Imprecisão Monetária com double', code: 'double total = 0.1 + 0.2;', symptom: 'Imprime 0.30000000000000004 no console', cause: 'O ponto flutuante padrão IEEE 754 não consegue representar frações decimais exatas binárias na Heap.', fix: 'Trabalhe com centavos usando inteiros long (ex: 10 centavos + 20 centavos = 30 centavos) ou BigDecimal.' },
