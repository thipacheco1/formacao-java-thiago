...
const ERRORS = [
  ...
  { title: 'Criar condição gigante na linha', code: 'if (A && B && C && D && E && !F) { ... }', symptom: 'Código ilegível e de difícil depuração por breakpoints', cause: 'Declarar operações demais em uma única condição.', fix: 'Quebre a expressão em booleanos locais explicativos, cada um com nome de domínio.' },
